...
export const FixedConstraintSchema = z.object({
  id: UUID,
...
export const EqualLengthConstraintSchema = z.object({
  id: UUID,
...
export const PlaneFeatureSchema = z.union([
...
export const ExtrudeDirectionSchema = z.union([
  z.enum(['normal', 'reverse']),
  Vec3,
]);
