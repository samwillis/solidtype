...
const FeatureIcon: React.FC<{ type: Feature['type'] }> = ({ type }) => {
  ...
  switch (type) {
    case 'sketch':
      return (
        <svg className={iconClass} width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <div className="feature-tree">
        ...
        <div className="feature-tree-content">
          <div className="feature-tree-empty">
            ...
            <p className="feature-tree-empty-title">No features yet</p>
            <p className="feature-tree-empty-hint">
              Use the toolbar above to create sketches and features.
            </p>
          </div>
        </div>
      </div>
