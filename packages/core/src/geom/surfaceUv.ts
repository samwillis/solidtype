...
import type { Surface, PlaneSurface, CylinderSurface, ConeSurface, SphereSurface } from './surface.js';
...
function torusPointToUV(
  torus: { kind: 'torus'; center: Vec3; axis: Vec3; majorRadius: number; minorRadius: number; uPerp?: Vec3; vPerp?: Vec3 },
  point: Vec3
): Vec2 {
...
function getTorusBasis(torus: { axis: Vec3; uPerp?: Vec3; vPerp?: Vec3 }): { uPerp: Vec3; vPerp: Vec3 } {
