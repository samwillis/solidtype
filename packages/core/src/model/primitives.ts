...
export function createBox(model: TopoModel, options: BoxOptions = {}): BodyId {
  ...
  createFaceWithLoop(model, shell, center, vec3(0, 0, -1), vec3(0, 0, -hh), vec3(1, 0, 0), [
  ...
  createFaceWithLoop(model, shell, center, vec3(-1, 0, 0), vec3(-hw, 0, 0), vec3(0, 1, 0), [
  ...
  createFaceWithLoop(model, shell, center, vec3(0, -1, 0), vec3(0, -hd, 0), vec3(-1, 0, 0), [
