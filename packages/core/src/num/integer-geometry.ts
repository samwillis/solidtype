...
export function segmentIntersection2I(
  p1: Vec2I, p2: Vec2I,  // Segment 1
  p3: Vec2I, p4: Vec2I   // Segment 2
): Vec2I | null {
  // Direction vectors
  const d1x = p2[0] - p1[0];
  const d1y = p2[1] - p1[1];
...
export function lineLineClosestPoints3I(
  p1: Vec3I, d1: Vec3I,  // Line 1: point and direction
  p2: Vec3I, d2: Vec3I   // Line 2: point and direction
): [Vec3I, Vec3I] | null {
  // w = p1 - p2
...
export function planePlaneIntersection(
  n1: Vec3I, p1: Vec3I,  // Plane 1: normal and point on plane
  n2: Vec3I, p2: Vec3I   // Plane 2: normal and point on plane
