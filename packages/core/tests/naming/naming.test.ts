...
import { booleanOperation } from "../../src/model/boolean.js";
import { createRectangleProfile } from "../../src/model/sketchProfile.js";
import { XY_PLANE, ZX_PLANE } from "../../src/model/planes.js";
import {
  createNamingStrategy,
  DefaultNamingStrategy,
  subshapeRefsMatch,
  fingerprintDistance,
} from "../../src/naming/evolution.js";
import {
  extrudeTopCapSelector,
  extrudeSideSelector,
  createPersistentRef,
} from "../../src/naming/types.js";
import type { NamingStrategy, SubshapeRef } from "../../src/naming/types.js";
import type { BodyId, FaceId, EdgeId } from "../../src/topo/handles.js";
